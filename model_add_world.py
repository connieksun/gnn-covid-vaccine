...
class STAN(nn.Module):
    def __init__(self, g, in_dim, hidden_dim1, hidden_dim2, gru_dim, num_heads, pred_window, device):
        ...
        self.gru = nn.GRUCell(hidden_dim2+pred_window, gru_dim)
    ...
    def forward(self, dynamic, cI, cR, N, I, R, world, h=None, V=None, e_weights=None):
        '''
        ...
        for each_step in range(timestep):
            ...
            h = self.gru(torch.cat((cur_h, world[each_step].unsqueeze(0)), dim=1), h)
        ...
        self.theta_scaled = torch.stack(self.theta_scaled).squeeze()
